...
# Tabs ordered correctly
available = df_view['Sub_Module'].dropna().unique().tolist()
display_submods = sorted(available, key=lambda s: (SUBMOD_ORDER.get(s, 99), s))
